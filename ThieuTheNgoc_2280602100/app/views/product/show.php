                ...
                <div class="row align-items-center">
                    <div class="col-md-6 text-center">
                        <?php if ($product->image): ?>
                            <img src="/pptp-mmm-22806021010/ThieuTheNgoc_2280602100/<?php echo htmlspecialchars($product->image, ENT_QUOTES, 'UTF-8'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-4 d-flex gap-2">
                            ...
                            <a href="/pptp-mmm-22806021010/ThieuTheNgoc_2280602100/Product/list" class="btn btn-secondary px-4">Quay lại danh sách</a>
                        </div>
                    </div>
                </div>
            <?php else: ?>
